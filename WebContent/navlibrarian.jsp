...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
   ...
   <li><a href="AddBookServlet">Add Book</a></li></ul>
      <ul class="nav navbar-nav">
      <li><a href="ViewBookServlet">View Book</a></li>
      </ul>
      <ul class="nav navbar-nav">
      <li><a href="IssueBookServlet">Issued Book</a></li>
      </ul>
      <ul class="nav navbar-nav">
...
<ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="LibrarianLogout"><span class="glyphicon glyphicon-log-out"></span><%=session.getAttribute("email")%> Logout</a></li>
    </ul>
    </div>
    </nav>
